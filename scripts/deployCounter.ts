...
export async function run() {
    ...
    const mnemonic =
        'artwork phone mention eager hint gold sleep bicycle icon liberty menu evil love range surprise teach salmon bulk sea cheese pudding magnet oppose eager';
